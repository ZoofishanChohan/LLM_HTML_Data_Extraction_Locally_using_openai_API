# Setting-up Local Environment for LLMS


I used Anaconda to set up my environment. It's a powerful tool that builds a complete science environment. Anaconda ensures that you're working with the right version of Python.
